...
_plan: _init
	terraform plan -var-file="configuration/custom-roles.auto.tfvars" -var-file="configuration/custom-role-assignments.auto.tfvars" -out=tfplan
...
_apply: _init
	terraform apply -var-file="configuration/custom-roles.auto.tfvars" -var-file="configuration/custom-role-assignments.auto.tfvars" -auto-approve
